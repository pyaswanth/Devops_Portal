...
const OrgEditModal =(props)=>{
    ...
    const[OrganizationName,setOrganizationName] = useState(props.data.organization)
    ...
    const handleClick = async () => {
        try {
          const data ={
            ...
            organization_id:props.data._id
          }
          console.log('org',data)
          const response = await axios.post('http://localhost:3001/api/dashboard-autoinfra/organizations/ModalEdit', data).then((response)=>{
    ...
    <div style={{padding:'1% 5% 5% 5%'}}>
        ...
        <Stack spacing={4} style={{paddingTop:'5%'}}>
            ...
            <Stack spacing={4} direction="row">
                <Button variant="contained" endIcon={<SaveIcon />} onClick={handleClick}>Save Changes</Button>
